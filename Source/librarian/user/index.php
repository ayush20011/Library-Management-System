...
<body>
	...
	<div class="slider">
		<div class="slide-carousel owl-carousel">
			<div class="item" style="background-image:url(dist/img/nit.jpeg); height:600px">
			...
			<div class="item" style="background-image:url(dist/img/nitmain.jpg); height:600px">
				<div class="overlay"></div>
				<div class="text">
					<div class="this-item">
						<h2>welcome to our library</h2>
			...
			<div class="item" style="background-image:url(dist/img/1.jpg); height:600px">
				<div class="overlay"></div>
				<div class="text">
					<div class="this-item">
						<h2>welcome to our library</h2>
			...
			<div class="item" style="background-image:url(dist/img/4.jpg); height:600px">
				<div class="overlay"></div>
				<div class="text">
					<div class="this-item">
						<h2>welcome to our library</h2>
			...
			<div class="item" style="background-image:url(dist/img/5.jpg); height:600px">
				<div class="overlay"></div>
				<div class="text">
					<div class="this-item">
						<h2>welcome to our library</h2>
			...
			<div class="item" style="background-image:url(dist/img/6.jpg); height:600px">
				<div class="overlay"></div>
				<div class="text">
					<div class="this-item">
						<h2>welcome to our library</h2>
	...
	<p><center>&copy This website is made by Ayush Singh.</center></p>
